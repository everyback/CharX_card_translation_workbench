...
import { applyApprovedSegments, isLikelyTranslatableText, type ApplicableSegment, type ScannedSegment } from './card.js';
import { readCharxEntries, readCharxEntry, writeCharxEntries } from './charx.js';
import {
  readRisuModuleAsset,
